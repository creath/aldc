...
uint256 hashGenesisBlock("0x000008c80e7ddbd55b114b53130cccb40c542f86b1967ee3d5d611e3f14b16dc");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AladinsCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AladinsCoin Signed Message:\n";
...
{
    // AladinsCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // AladinsCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "aldc genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //(block.hashMerkleRoot == uint256("0xb0019d92bc054f0418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a"));
...
unsigned char pchMessageStart[4] = { 0xce, 0xce, 0xa9, 0xde }; // AladinsCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AladinsCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AladinsCoinMiner : ProcessBlock, block not accepted");
    }
